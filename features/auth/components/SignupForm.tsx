  ...
  return (
    <>
      ...
      <div className="text-center mb-8">
        <h2 className="font-syne text-2xl font-bold text-slate-100 mb-2">Create account</h2>
        <p className="text-slate-400 text-sm font-dm-sans">Start finding and reaching businesses today</p>
      </div>

      {/* Form */}
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        <div>
          <label className="block text-slate-300 text-sm font-medium mb-1.5 px-1">Full Name</label>
          <input 
